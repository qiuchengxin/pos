...
public class RankMin {
    public static String ask;

    public static void rankMin(String qqid,String groupid){
        ...
        askQQMessage.setMsg("[CQ:at,qq=" + qqid + "] " +
                "\n倒数第一： " + first_username + " 修为： " + first_grade + " 境界： " + firstDengji + "" +
                "\n倒数第二： " + second_username + " 修为： " + second_grade + " 境界： " + secondDengji + "" +
                "\n倒数第三： " + third_username + " 修为： " + third_grade + " 境界： " + thirdDengji + "" +
                "\n您的排名是 ：第 " + myRank + " 位 ！" );
